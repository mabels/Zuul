...
var MAX_DOCS = 1; // The maximum number of docs to send in a single batch
...
//console.log('-4-'+require('util').inspect(options)+"="+(uri.protocolHandler == http));
...
console.log("Bulk Getting %s documents", require('util').inspect(keys));
